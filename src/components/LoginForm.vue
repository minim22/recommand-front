  ...
  <div class="login-bg">
    <div class="login-card">
      ...
      <div class="divider">또는</div>
        <button class="btn google gsi-material-button">
      ...
      <button class="btn kakao" @click="loginWithKakao">Kakao 로그인</button>
    </div>
...
.btn.kakao {
  background: #FEE500;
  color: #3A1E1D;
  box-shadow: 0 3px 10px rgba(254, 229, 0, 0.25);
}
